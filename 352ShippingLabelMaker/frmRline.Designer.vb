...
Partial Class frmRline
    ...
    Private Sub InitializeComponent()
        ...
        Me.CboColour.Items.AddRange(New Object() {"TITANIUM BEIGE - (A1X)", "FORTANA RED - (B3Z)", "KURKUMA MET - (R1X)", "REFLEX SILVER - (A7W)", "PURE WHITE - (C9A)", "DEEP BLACK PEARL - (C9X)", "TOURMALINE BLUE - (P5Y)", "PLATINUM GRAY - (D7X)", "HUNTING BROWN - (A8U)", "PRIME - (GRU)"})
